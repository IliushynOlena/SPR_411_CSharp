...
namespace _07_OverloadOperator
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            _2D_Point p2 = new _2D_Point(2, 5);
            ...
            string str1 = "Hello";//1c4d5d5d
            string str2 = "Ivan";////1c4d5d5d
            ...
            double f = 3.14;
            // int to double
            f = d;// f = 5 -- implicit  int >> double

            //d = f;//implicit double --> int
            d = (int)f;//explicit double --> int

            d = (int)p2;  //  2DPoint ---> int 
            Console.WriteLine(d);
